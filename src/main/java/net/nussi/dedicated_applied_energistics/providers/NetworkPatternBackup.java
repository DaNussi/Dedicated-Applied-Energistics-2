...
public class NetworkPatternBackup extends DedicatedAppliedEnergisticsController.Controllable {
    ...
    public NetworkPatternBackup(IPatternDetails pattern, String origin, boolean exists, Level level) {
    ...
    public static NetworkPatternBackup fromString(String data, Level level, Jedis jedis) throws CommandSyntaxException {
        ...
        return new NetworkPatternBackup(pattern, origin, exists, level);
    }

    public static String toString(NetworkPatternBackup networkPattern) {
    ...
    private static CompoundTag convertIPatternDetailsToCompoundTag(IPatternDetails pattern, NetworkPatternBackup networkPattern) {
    ...
    private static CompoundTag convertIInputToCompoundTag(IPatternDetails.IInput data, NetworkPatternBackup networkPattern) {
        CompoundTag compoundTag = new CompoundTag();
    ...
    private static CompoundTag convertIInputListToCompoundTag(IPatternDetails.IInput[] data, NetworkPatternBackup networkPattern) {
        CompoundTag compoundTag = new CompoundTag();
